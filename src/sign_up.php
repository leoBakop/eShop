...
<body>
<form  method="GET"> <!--action="welcome.php" it sends the data in the .php page  -->
...
<?php
    ...
    if(array_key_exists('sign_up', $_GET)) 
        sign_up_sql($_GET["name"], $_GET["surname"],
                        $_GET["username"],$_GET["password"],$_GET["email"],$_GET["role"],$con);
